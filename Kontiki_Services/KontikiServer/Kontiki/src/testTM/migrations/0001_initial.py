# Generated by Django 5.1 on 2024-10-29 05:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salaire', models.FloatField(max_length=255)),
                ('traite', models.BooleanField(max_length=255)),
                ('remunere', models.BooleanField(max_length=255)),
                ('travailler_soir', models.BooleanField(max_length=255)),
                ('competence_aporte', models.CharField(max_length=255)),
                ('redaction_email_colab', models.CharField(max_length=255)),
                ('strategie_convincre', models.CharField(max_length=255)),
                ('choix_long_term', models.CharField(max_length=255)),
                ('cinq_marque_frs_femme', models.CharField(max_length=255)),
                ('cinq_marque_frs_homme', models.CharField(max_length=255)),
            ],
        ),
    ]
